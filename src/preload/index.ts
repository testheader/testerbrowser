...
contextBridge.exposeInMainWorld('testerBrowser', {
  ...
  layout: {
    ...
    beginPageOverlay: () => ipcRenderer.invoke('layout:beginPageOverlay'),
    endPageOverlay: () => ipcRenderer.invoke('layout:endPageOverlay'),
  },
  ...
  a11y: {
    ...
    getViolations: (id: string) => ipcRenderer.invoke('a11y:getViolations', id),
    ...
    setFocusOverlay: (id: string, enabled: boolean) => ipcRenderer.invoke('a11y:setFocusOverlay', id, enabled),
    detectFocusTrap: (id: string) => ipcRenderer.invoke('a11y:detectFocusTrap', id),
